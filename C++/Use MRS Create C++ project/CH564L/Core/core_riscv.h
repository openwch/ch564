 ...
 * Version            : V1.0.1
 * Date               : 2023/11/11
 * Description        : RISC-V V4 Core Peripheral Access Layer Header File for CH564
 *********************************************************************************
 ...
 * @return  none
 */
__attribute__( ( always_inline ) ) RV_STATIC_INLINE void ICacheInvalidate_By_Address(
 ...
 * @return  none
 */
__attribute__( ( always_inline ) ) RV_STATIC_INLINE void DCacheClean(void) {
    WRITE_CSR(0xBD0, 0x5);
    __asm volatile ("fence.i");
}
 ...
 * @return  none
 */
__attribute__( ( always_inline ) ) RV_STATIC_INLINE void DCacheInvalidate(void) {
    WRITE_CSR(0xBD0, 0x6);
    __asm volatile ("fence.i");
}

/*********************************************************************
 * @fn      DCacheCleanInvalidate
 *
 * @brief   Clean and Invalidate DCache
 *
 * @return  none
 */
__attribute__( ( always_inline ) ) RV_STATIC_INLINE void DCacheCleanInvalidate(
        void) {
    WRITE_CSR(0xBD0, 0x7);
    __asm volatile ("fence.i");
}
