...
/* Global Variable */
const u8 TEXT_Buffer[] = {"CH564 I2C TEST"};
...
u8 AT24CXX_ReadOneByte(u16 ReadAddr)
{
    ...
    while (!I2C_CheckEvent(I2C, I2C_EVENT_MASTER_MODE_SELECT))
        ;
    I2C_Send7bitAddress(I2C, 0XA0, I2C_Direction_Transmitter);

    while (!I2C_CheckEvent(I2C, I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED))
        ;

#if (Address_Lenth == Address_8bit)
    I2C_SendData(I2C, (u8)(ReadAddr & 0x00FF));
    while (!I2C_CheckEvent(I2C, I2C_EVENT_MASTER_BYTE_TRANSMITTED))
        ;

#elif (Address_Lenth == Address_16bit)
    I2C_SendData(I2C, (u8)(ReadAddr >> 8));
    while (!I2C_CheckEvent(I2C, I2C_EVENT_MASTER_BYTE_TRANSMITTED))
        ;
    ...
    while (!I2C_CheckEvent(I2C, I2C_EVENT_MASTER_MODE_SELECT))
        ;
    I2C_Send7bitAddress(I2C, 0XA0, I2C_Direction_Receiver);
...
#if (Address_Lenth == Address_8bit)
    I2C_SendData(I2C, (u8)(WriteAddr & 0x00FF));
    while (!I2C_CheckEvent(I2C, I2C_EVENT_MASTER_BYTE_TRANSMITTED))
        ;

#elif (Address_Lenth == Address_16bit)
    I2C_SendData(I2C, (u8)(WriteAddr >> 8));
    while (!I2C_CheckEvent(I2C, I2C_EVENT_MASTER_BYTE_TRANSMITTED))
        ;
