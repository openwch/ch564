...
/*
 *@Note
 *SPI half duplex mode, master/slave mode, data transceiver:
 ...
 *
 *This example demonstrates that Master and Slave half-duplex transmission.
...
int main(void)
{
    ...
    printf("ChipID:%08x\r\n", ChipID);
    printf("SPI0 Receive & Transmit Routine\r\n");
    ...
    GPIOB_ResetBits(SCS);
    SPI0_MasterTrans((uint8_t *)spi_Tx, usize);
    Delay_Us(100);
    SPI0_MasterRecv((uint8_t *)spi_Rx, usize);
    ...
    SPI0_SlaveRecv((uint8_t *)spi_Rx, usize);

    SPI0_SlaveTrans((uint8_t *)spi_Tx, usize);
